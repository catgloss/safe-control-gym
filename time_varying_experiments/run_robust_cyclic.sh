...
python3 plot_controller_white_noise_cyclic.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir ./baselines/experiment_results/ppo_cartpole_new --thread 1 --seed 222 --func test
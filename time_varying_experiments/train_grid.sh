...
do
    python3 plot_controller_white_noise_action.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_action_2/std_$noise" --thread 1 --func train --noise $noise --device cuda
done 

for noise in "${noises_white_noise_actions[@]}"
do
    python3 plot_controller_white_noise_action.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_action_2/std_$noise" --thread 1 --func plot --noise $noise --device cuda
done

for noise in "${noises_white_noise_dynamics[@]}"
do 
    python3 plot_controller_white_noise_dynamics.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_dynamics_2/std_$noise" --thread 1 --func train --noise $noise --device cuda
done

for noise in "${noises_white_noise_dynamics[@]}"
do 
    python3 plot_controller_white_noise_dynamics.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_dynamics_2/std_$noise" --thread 1 --func plot --noise $noise --device cuda
done

for noise in "${noises_white_noise_obs[@]}"
do 
    python3 plot_controller_white_noise_obs.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_obs_2/std_$noise" --thread 1 --func train --noise $noise --device cuda
done

for noise in "${noises_white_noise_obs[@]}"
do 
    python3 plot_controller_white_noise_obs.py --algo ppo --task cartpole --overrides ./baselines/configs/ppo_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/ppo/white_noise_obs_2/std_$noise" --thread 1 --func plot --noise $noise --device cuda
done
...
# for noise in "${noises_white_noise_obs[@]}"
# do 
#     python3 plot_controller_white_noise_obs.py --algo rap --task cartpole --overrides ./baselines/configs/rap_cartpole.yaml --output_dir "./baselines/experiment_results/experiment_results/rap/white_noise_obs_2/std_$noise" --thread 1 --func plot --noise $noise --device cuda
# done
